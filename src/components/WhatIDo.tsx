        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build the infrastructure behind it: ETL pipelines, cloud-based
                ML systems, and dashboards—production-ready, scalable, and built
                to handle real data at volume.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
